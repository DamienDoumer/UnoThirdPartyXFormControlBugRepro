...
using XamarinWebAssembly.Controls;
using XamarinWebAssembly.UWP;

[assembly: ExportRenderer(typeof(PancakeView), typeof(PancakeViewRenderer))]
namespace XamarinWebAssembly.UWP
{
    class PancakeViewRenderer : ViewRenderer<PancakeView, Border>
    {
        /// <summary>
